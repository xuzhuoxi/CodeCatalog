...
- [swift-3-api-guidelines-review](https://github.com/apple/swift-3-api-guidelines-review.git)
...
- [SwiftFilePath](https://github.com/nori0620/SwiftFilePath.git)
...
- [ThreeMatchSprite](https://github.com/lsdimagine/ThreeMatchSprite.git)

  A simple three match game on the SpriteKit

## HTML5/TypeScript/JavaScript/ActionScript
...
- [egret-ios-support](https://github.com/egret-labs/egret-ios-support.git)
...
- [egret_gesture](https://github.com/NeoGuo/egret_gesture.git)
...
- [uLua](https://github.com/jarjin/uLua.git)

  基于cstolua的修改版uLua 【已停止更新】 
  http://ulua.org/

- [slua](https://github.com/pangweiwei/slua.git)

  Fastest lua binding via static code generating for Unity3D and mono.
  
- [tolua](https://github.com/topameng/tolua.git)

  The fastest unity lua binding solution

- [tolua_runtime](https://github.com/topameng/tolua_runtime.git)
...
- [UnityHello](https://github.com/woshihuo12/UnityHello.git)
  ...
  Unity版hello world,演示了各种tolua相关的hello world级程序
...
- [Unity-AudioManager](https://github.com/jconst/Unity-AudioManager.git)
